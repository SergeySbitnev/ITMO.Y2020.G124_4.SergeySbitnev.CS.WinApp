...
namespace ITMO.CS.WinApp.LabWork8.Task6.UsabilityDemo
{
    /// <summary>
    ...
    public class UsabilityDemo : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.UsabilityDemo_FormClosing);
        ...
        private void UsabilityDemo_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
